...
Prefer concrete behavioral triggers over abstract labels.
...
- avoid repeating the same clause roots across sections (e.g. 3 lines starting with "Ты ... когда ...")
- avoid mirror duplicates between passport_hero and social_summary; if idea already used, express a different angle or skip
...
- magnets[3]: specific things that attract people (grounded in social_axes + tags), НЕ повторять формулировки из passport_hero.magnet
- repellers[3]: specific things that push people away (honest, not sugarcoated), НЕ повторять passport_hero.repulsion
- people_come_for: 1 line — what people need from this artist
- people_leave_when: 1 line — why people leave
- taboos[5]: brand/charisma breakers (concrete actions), не дублировать passport_hero.taboo
...
- lexical diversity: no near-identical phrases across magnet/repellers/taboos/scripts
...
- Keep sentence shapes varied: do not repeat one template 3+ times in a row.
...
Never duplicate the same idea between passport_hero and social_summary in almost identical wording.
...
══════════════════════════════
magnets (array of 3 strings): "Люди остаются, потому что ты [behavior]." — новый угол, НЕ копия passport_hero.magnet.
repellers (array of 3 strings): "Люди отваливаются, когда ты [trigger]." — новый угол, НЕ копия passport_hero.repulsion.
...
taboos (array of 5 strings): отдельные социальные табу, НЕ дублировать passport_hero.taboo.
scripts:
...
8. No repeated stems between magnet/repulsion/taboo (e.g. "когда ты молчишь..." repeated with tiny edits).
9. social_summary must add NEW meanings and wording; never mirror passport_hero line-by-line.
